<?php
/**
* Combines two or more rules into a list. Any rule in the list is executed and the returned array
* are merged.
*
 ...
 * @subpackage Free-Redirects
 */
class PapayaModuleRedirectsRulePatternOr implements PapayaModuleRedirectsRulePattern {
